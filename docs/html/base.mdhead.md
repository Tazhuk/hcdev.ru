---
description: Тег base (от англ. base - основа) определен внутри контейнера head и инструктирует браузер относительhttps://github.com/xsltdev/hcdev.ru/blob/master/docs/html/base.mdно полного базового адреса текущего документа
---
